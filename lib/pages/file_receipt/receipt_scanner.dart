...
import 'package:majdur_p/pages/file_receipt/file_receipt_DB.dart';
import '../common_scanner.dart';


class ScanDirectPage extends StatelessWidget {
  const ScanDirectPage({super.key});
        ...
        child: ElevatedButton(
          ...
          onPressed: () async {
            ...
            if (scanned != null && scanned.isNotEmpty) {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => FileReceipt(rawJson: scanned)),
              );
            } else {
